...
var _selectFilterInput = require('../helpers/selectFilterInput');

var _selectFilterInput2 = _interopRequireDefault(_selectFilterInput);
...
var SelectFilterInput = function (_Component) {
  _inherits(SelectFilterInput, _Component);
  ...
  function SelectFilterInput() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectFilterInput.__proto__ || Object.getPrototypeOf(SelectFilterInput)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_reactInputForms2.default, { type: 'select-filter', options: optionList, value: basicinput, name: 'basicinput', label: 'basic input ', onChange: _this.handleUpdateValue }),
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_reactInputForms2.default, { type: 'select-filter', options: optionList, customElement: _this.customElementSelect, value: customElement, name: 'customElement', label: 'custom element', onChange: _this.handleUpdateValue }),
        _react2.default.createElement(
          'pre',
          null,
          _react2.default.createElement(
  ...
  _createClass(SelectFilterInput, [{
    ...
    value: function render() {
      var prosType = (0, _selectFilterInput2.default)('th');
      return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(
